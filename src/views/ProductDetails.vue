<template>
  ...
  export default {
    ...
    data() {
      return {
        products: [
          { id: 1, name: 'Wireless Mouse', description: 'Ergonomic and responsive wireless mouse.', price: 19.99, image: '/mouse.jpg' },
          { id: 2, name: 'Mechanical Keyboard', description: 'Tactile keys with RGB lighting.', price: 59.99, image: '/keyboard.jpg' },
          { id: 3, name: 'HD Webcam', description: '1080p webcam with built-in mic.', price: 29.99, image: '/webcam.jpg' },
          { id: 4, name: 'Noise Cancelling Headphones', description: 'Wireless headphones with ANC.', price: 89.99, image: '/headphones.jpg' },
        ],
        product: {}
      }
    },
